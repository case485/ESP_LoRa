...
# Ifrom micropython import const
import framebufoimport sys
import os
import time
import machine 
import ubinascii
...
lora = SX127x(device_spi, pins=device_config, parameters=lora_p
# example = 'receiver'
